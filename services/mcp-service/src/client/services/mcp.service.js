...
async function rememberResolvedDayType(conversationId, dayType, source) {
...
async function updateConversationStateByTool({ conversationId, toolName, args, toolResult }) {
...
async function updateStateAfterFinalText({ conversationId, text, hasDayType }) {
